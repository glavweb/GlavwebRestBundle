...
namespace Glavweb\RestBundle\Generator;
 ...
 * @package Glavweb\RestBundle\Generator
 */
class ScopeGenerator extends Generator
{
     ...
     */
    public function __construct(KernelInterface $kernel, Registry $doctrine, $kernelRootDir, $skeletonDirectories)
    {
        $this->kernel = $kernel;
    ...
    private function getTemplatePath($modelClass)
    {
        ...
        $fixturePath = $this->kernelRootDir . '/config/scopes/_examples/'
